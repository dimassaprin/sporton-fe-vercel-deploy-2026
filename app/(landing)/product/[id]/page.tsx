    ...
    <main className="container mx-auto py-40 flex gap-12">
      ...
      <div className="w-full py-7">
        ...
        <p className="leading-loose mb-8">
          The SportsOn HyperSoccer v2 is engineered for the player who demands <br />
          precision, power, and unrivaled speed on the pitch. Featuring a
          striking, two- <br />toned black and white design with deep crimson accents,
          these cleats don't <br />just perform—they make a statement. Experience the
          future of football <br />footwear with v2's enhanced fit and cutting-edge
          traction.
        </p>
